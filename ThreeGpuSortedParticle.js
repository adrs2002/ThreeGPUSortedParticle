...
class ThreeGpuSortedParticle extends THREE.Object3D {
    ...
    */
    ...
    setViscosity(_id, _v){
        this.dataArray3[_id * 4 + 2] = _v;
    }

    getViscosity(_id){
      return this.dataArray3[_id * 4 + 2];
    }
    ...
    */
    _getParticleDrawVshader() {
        ...
        void main() {
            ...
            vUv2 = uv * 0.25  + vec2(indexUv.x * 1.4, indexUv.y * 1.4);

            // 位置を算出
            vec3 movePow =  vec3(valVec.xyz) * valVec.w * timeF ;
            vec4 mvPosition = modelViewMatrix * vec4( valPos.xyz + movePow.xyz, 1.0 );
    ...
    _getParticleDrawFshader(_colCount) {
        ...
        void main() {
            ...
            float f = (texColor.x - 0.4) / (1.0 - 0.4 * 2.0);
    ...
    _getPreRendShader() {
        ...
        void main() {
            ...
            vec3 movePow =  vec3(valVec.xyz) * (valVec.w + timeF);
            vec3 putPosition = vec3(valPos.xyz) + movePow ;
